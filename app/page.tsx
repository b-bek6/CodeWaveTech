...
export default function page() {
    return (
        <>
            <div className="   md:overflow-scroll overflow-hidden max-w-screen text-black bg-slate-200 ">


               

                <div className="  grid h-screen grid-rows-3 justify-center text-center items-center">
                    <div>
                        <h2 className=" text-xl  ">Code Wave Tech</h2>
                    </div>
                    <div>

                    <div className="  grid gap-4 align-middle justify-center text-center" >
                        <h1 className=" z-50 text-4xl font-bold "> We are coming soon</h1>
                    ...
                    <div className="mt-5 grid gap-4">
                        ...
                        <div className=" z-50  font-bold grid gap-4 justify-center grid-flow-col" >
                            <Notify />
                    ...
                    <div className=" opacity-80  absolute bottom-0 w-screen overflow-hidden ">
                        <svg  xmlns="http://www.w3.org/2000/svg" version="1.1" width="1440" height="1080" preserveAspectRatio="none" viewBox="0 0 1440 1080">
