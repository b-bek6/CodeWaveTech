    ...
    <>
      <div className='grid md:grid-flow-col  grid-flow-row md:grid-cols-3 gap-4 justify-center text-white'>
        <div className='flex gap-2 md:justify-center items-center'>
          <Link href={`mailto:info@codewave.com.np?subject=Subscribe&body=Write us a message`}><div className='btns flex justify-center items-center w-10 h-10 bg-fourth text-primary'><MdOutlineEmail /></div></Link>
        ...
        <div className='flex gap-2 md:justify-center items-center'>
          <Link href={`tel:9851008523`}> <div className='btns flex justify-center items-center w-10 h-10 bg-fourth text-primary'><FaPhone /></div></Link>
