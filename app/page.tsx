    ...
    return (
        <>
            <div className="md:overflow-scroll h-fit overflow-hidden max-w-screen text-black bg-slate-200 ">
                <div className="grid grid-rows-3 h-[100vh] sm:h-[screen] justify-center items-center ">
                    <div>
                        <h2 className="text-3xl font-bold md:text-4xl mt-20">Code Wave Tech Pvt Ltd</h2>
                        <div className="z-50">
                            <div className="mt-5">
                                <Footer />
                            </div>
                    ...
                    <div className="  grid  justify-center text-center" >
                        <h1 className=" z-50 text-2xl text-white rounded-full p-4 px-20 hover:scale-110 transition ease-in-out duration-150 font-bold font-sans bg-gradient-to-r from-primary to-fourth"> We are coming soon</h1>
                    </div>
                </div>
                <div className=" opacity-80  absolute bottom-0 -screen overflow-hidden ">
