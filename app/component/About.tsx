...
export default function About() {
  ...
  return (
    <>
      ...
      <div  className={`h-[100vh]   z-50 opacity-100 w-screen text-white absolute bg-secondary transition right-0 top-0 md:w-[500px] ease-in-out delay-150 ${hidden ? " translate-x-[800px] md:translate-x-[500px] sm:translate-x-[800px] hidden" : ""} `}>
